...
@JsonIgnoreProperties(ignoreUnknown = true, value = "pageable") // ignore pageable property
public class BeerDTOPageImpl<BeerDTO> extends PageImpl<guru.springframework.spring6resttemplate.model.BeerDTO> { // had to give fully qualified name for BeerDTO for jackson to work

    @JsonCreator(mode = JsonCreator.Mode.PROPERTIES) // tells Jackson to use this constructor
